...
import { RevokeAllSessionStatesForUserService } from "../sessions/revokeAllSessionStatesForUser.service"
...
export class PasswordResetConfirmService {
  constructor(
    ...
    private readonly revokeAllSessionStatesForUserService: RevokeAllSessionStatesForUserService,
  ) {}
  ...
  public async execute(changePasswordData: ChangePasswordDto, token: string): Promise<void> {
    ...
    await this.revokeAllSessionStatesForUserService.execute(user.id)
